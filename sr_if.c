...
/*--------------------------------------------------------------------- 
 * Method: sr_provjeriIP
 * Scope: Global
 *
 * Provjera da li je odredisna IP adresa jedna od adresa u routing tabeli.
 *
 *---------------------------------------------------------------------*/

bool sr_provjeriIP (struct sr_instance* sr, uint32_t ipd) {
  struct sr_if* if_walker = 0;
    /* -- REQUIRES -- */
    assert(sr);
...
/*--------------------------------------------------------------------- 
 * Method: vrati_ip_adresu_source_interfejsa_routera
 * Scope: Global
 *
 * 
 *
 *---------------------------------------------------------------------*/
uint32_t vrati_ip_adresu_source_interfejsa_routera(struct sr_instance* sr, char* interface/* lent */){
  struct sr_if* if_walker = 0;
    /* -- REQUIRES -- */
    assert(sr);
...
/*--------------------------------------------------------------------- 
 * Method: vrati_mac_adresu_interfejsa_routera
 * Scope: Global
 *
 * 
 *
 *---------------------------------------------------------------------*/
uint8_t vrati_mac_adresu_interfejsa_routera(struct sr_instance* sr, char* interface/* lent */){
  struct sr_if* if_walker = 0;
    /* -- REQUIRES -- */
    assert(sr);
